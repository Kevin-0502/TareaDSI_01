//
//  ViewControllerTeatro.swift
//  Ejemplo3
//
//  Created by Kevin Jimenez on 24/9/21.
//
import UIKit
class ViewControllerTeatro: UIViewController , UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        if(sm.sitios![indexPath.row].categoria == "Teatro"){
            return 150
        }
        return 0
    }
